...
static std::string
_Repr(const IDTXMockDatasource_RandomFloat &self)
{
    std::string primRepr = TfPyRepr(self.GetPrim());
    return TfStringPrintf(
        "IDTX.MockDatasource_RandomFloat(%s)",
        primRepr.c_str());
}

} // anonymous namespace

void wrapIDTXMockDatasource_RandomFloat()
{
    typedef IDTXMockDatasource_RandomFloat This;

    class_<This, bases<IDTXDatasource> >
        cls("MockDatasource_RandomFloat");
